...
public class GUISwimmingpool {
    ...
    public GUISwimmingpool() {
        start();
        EntranceWaitingQueue adventureQueue = new EntranceWaitingQueue(lblWadv);
        EntranceWaitingQueue commonQueue = new EntranceWaitingQueue(lblWcom);
        AdventurePool adventurePool = new AdventurePool(10, lblAdvLim, lblAdvNr);
        CommonPool commonPool = new CommonPool(10, lblComLim, lblComNr);
        AdventurePoolInputQueue adventurePoolInputQueue = new AdventurePoolInputQueue(adventurePool, commonPool, adventureQueue);
        CommonPoolInputQueue commonPoolInputQueue = new CommonPoolInputQueue(adventurePool, commonPool, commonQueue);
        reception = new Reception(adventureQueue, commonQueue);
        CustomerExit customerExit = new CustomerExit(adventurePool, commonPool, lblCexit, lblAexit);
